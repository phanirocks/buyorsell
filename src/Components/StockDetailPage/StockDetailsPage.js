...
const StockDetailPage = (props) => {
    ...
    const getPercentDetailsFirestore = async () => {
        ...
        firestore.collection('stockDetails').where('stockName','==', props.match.params.stockName).onSnapshot(querySnapshot => {
            ...
            <div className="stockDetailPage-Content">
                <div>
                    ...
                    <div className="buttonBlock"> 
                        ...
                        { (userChoiceFromStorage.stockName !== props.match.params.stockName 
                        || 
                        ((userChoiceFromStorage.action !== "BUY" ) && (userChoiceFromStorage.stockName === props.match.params.stockName || !userChoiceFromStorage.stockName ))) 
                        && 
                        ...
                        { (userChoiceFromStorage.stockName !== props.match.params.stockName 
                        || 
                        ((userChoiceFromStorage.action !== "SELL") && (userChoiceFromStorage.stockName === props.match.params.stockName || !userChoiceFromStorage.stockName ))) 
                        && 
                        ...
                        { (userChoiceFromStorage.stockName !== props.match.params.stockName 
                        || 
                        ((userChoiceFromStorage.action !== "HOLD") && (userChoiceFromStorage.stockName === props.match.params.stockName || !userChoiceFromStorage.stockName ))) 
                        && 
